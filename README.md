...
O TechMed contribui com esse cenário ao centralizar as informações em uma interface simples, permitindo visualizar a lista de medicamentos, acompanhar a agenda do dia, receber alertas de horário e atraso, além de marcar quando o medicamento foi tomado.
...
* Alerta laranja para medicamentos pendentes há algumas horas.
* Alerta vermelho para medicamentos que ficaram pendentes desde outro dia.
* Marcação de medicamento como tomado.
* Redefinição diária dos status para iniciar um novo ciclo de acompanhamento.
...
4. Consulte a tela **Lista de medicamentos** para editar, excluir ou limpar os dados.
5. Acesse **Visualizar horário do remédio** para acompanhar a agenda, verificar o próximo medicamento, observar alertas e marcar itens como tomados.
